...
7. `(((p->q)->r)->s)->(q->r)->(p->s)`
```
p, p->q, q->r, ((p->q)->r)->s |- p  # Id
p, p->q, q->r, ((p->q)->r)->s |- p->q  # Id
p, p->q, q->r, ((p->q)->r)->s |- q  # MP
p, p->q, q->r, ((p->q)->r)->s |- q->r  # Id
p, p->q, q->r, ((p->q)->r)->s |- r  # MP
p, q->r, ((p->q)->r)->s |- (p->q)->r  # DT
p, q->r, ((p->q)->r)->s |- ((p->q)->r)->s  # Id
p, q->r, ((p->q)->r)->s |- s  # MP
q->r, ((p->q)->r)->s |- p->s  # DT
((p->q)->r)->s |- (q->r)->(p->s)  # DT
|- (((p->q)->r)->s)->(q->r)->(p->s)  # DT
